...
CREATE TABLE `favorite` (
  ...
  CONSTRAINT `favorite_ibfk_2` FOREIGN KEY (`gameID`) REFERENCES `games` (`gameID`)
...
INSERT INTO `favorite` VALUES ('vibach2003',1061075),('vibach2003',1099055);
...
-- Dump completed on 2024-10-29 19:57:20
