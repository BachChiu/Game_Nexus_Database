...
CREATE TABLE `follow` (
  ...
  CONSTRAINT `follow_ibfk_2` FOREIGN KEY (`creatorID`) REFERENCES `content_creator` (`creatorID`)
...
INSERT INTO `follow` VALUES ('vibach2003',1),('vibach2003',2),('vibach2003',3),('vibach2003',4),('vibach2003',5),('vibach2003',7),('vibach2003',10),('vibach2003',12);
